...
import (
	...
	multitenancyv1 "github.com/kondoumh/go-study/kubebuilder/api/v1"
	"github.com/kondoumh/go-study/kubebuilder/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "23708455.example.com",
	})
	if err != nil {
